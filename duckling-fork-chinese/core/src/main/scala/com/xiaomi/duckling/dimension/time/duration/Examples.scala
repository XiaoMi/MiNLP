...
trait Examples extends DimExamples {
  ...
  override def pairs: List[(ResolvedValue, List[String])] = List(
    ...
    (DurationData(90, Second, schema = Some("PT1.5M")), List("1分半", "1分半钟")),
    ...
    (DurationData(30, Minute, schema = Some("PT0.5H")), List("半小时","0.5小时")),
    (DurationData(30, Minute, schema = Some("PT30M")), List("30分钟")),
    (DurationData(12, Hour, schema = Some("P0.5D")), List("半天")),
    (DurationData(90, Minute, schema = Some("PT1.5H")), List("一个半小时")),
    (DurationData(90, Minute, schema = Some("PT1H30M")), List("一小时30分钟", "一个小时30分钟")),
    (DurationData(2, Hour, schema = Some("PT2H")), List("两个小时")),
    (DurationData(45, Day, schema = Some("P1.5M")), List("一个半月")),
    (DurationData(15, Day, schema = Some("P0.5M")), List("半个月")),
