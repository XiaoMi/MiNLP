...
import duckling.dimension.time.{TimeData, _}
import duckling.dimension.time.enums._
import duckling.dimension.time.enums.AMPM.{AM, PM}
...
import duckling.dimension.time.predicates.{EmptyTimePredicate, TimeDatePredicate}
